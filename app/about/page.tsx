...
export const metadata: Metadata = {
  title: 'About | Tatūlogue',
  description:
    'Tatūlogue is a platform that connects tattoo artists and enthusiasts — discover artists by style, explore portfolios, and learn through The Tatulogue Journal.',
};
  ...
  return (
    <main className="min-h-screen bg-[#07070d] text-white">
      ...
      <div className="max-w-3xl mx-auto px-6 py-16">
        <h1 className="text-4xl font-black mb-2">About Tatūlogue</h1>
        ...
        <div className="space-y-10 text-white/70 leading-relaxed text-sm">
          <Section title="What Tatūlogue Is">
            <p>
              Tatūlogue is a platform built to connect tattoo artists with the people who want
          ...
          <Section title="Why We Exist">
            ...
            <p>
              Tatūlogue exists to fix that gap. By organizing artists and their work around style
          ...
          <Section title="Who It&apos;s For">
            <p>
              Tatūlogue serves two communities. Licensed tattoo artists use it to build a portfolio,
          ...
          <Section title="Who&apos;s Behind It">
            <p>
              Tatūlogue is built and operated by TATULOGUE, LLC, a company organized in the State of
