...
This is the part people resist most. You wanted a small fix and the artist is sketching something twice the size. That's not an upsell. As the [Tattoodo cover-up guide](https://www.tattoodo.com/guides/a-guide-to-cover-up-tattoos) lays out, a bigger canvas is usually the only way to get clean coverage with intentional-looking design instead of a black blob. Going bigger is the price of doing it right.
...
The fix is fading. A few rounds of laser knocks the old saturation down enough that an artist actually has contrast to work with. According to the [American Society for Laser Medicine & Surgery](https://www.aslms.org/for-the-public/treatments-using-lasers-and-energy-based-devices/tattoo-removal), Q-switched lasers shatter the ink into tiny particles that your immune system then clears out over the following weeks — the same macrophage cleanup that makes all tattoos slowly fade, just forced and concentrated. You don't need full removal, just enough fade to give the new piece room.

The same skin-overworking math applies here — once you've fought layers of ink and laser through one patch of dermis, the tissue has limits. We broke that down in [what overworked skin actually does to a tattoo](/blog/overworked-skin-tattoo), and it's worth reading before you stack a cover-up on top of an already-hammered area.
...
Blastovers are a whole aesthetic, not a compromise. As [Solana Tattoo Company explains the cover-up versus blastover split](https://www.solanatattoo.com/post/tattoo-cover-up-vs-blastover-what-s-the-difference), the blastover leans into the contrast — a stark, bold banger sitting over the soft faded grey of whatever was there before. It reads as deliberate layering, like a sticker slapped over an old one.
...
Japanese is built for this. Big black backgrounds, wind bars, waves, and dark fills are coverage machines, which is partly why the style evolved the way it did — there's real depth in [Japanese tattoo history and iconography](/blog/japanese-tattoo-history-iconography) worth knowing before you commit to that route. And steer away from anything delicate. The reason [watercolour tattoos age the way they do](/blog/watercolour-tattoos-how-they-age) — no outline, soft washes — is the exact reason they can't cover anything.
...
If you're working through a regret piece and want to stay sharp on what actually holds, the [Tatulogue newsletter at tatulogue.com](https://tatulogue.com) tracks this stuff — real healed cover-ups, blastover breakdowns, and no content-farm filler. We're also building the catalogue collectors have needed for years through our [Tatulogue Kickstarter](https://tatulogue.com) — healed work with context, so you're never booking blind again.
  ...
  "mainEntity": [
    {
      ...
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Not cleanly. Faded, lighter, or amateur tattoos cover easily with darker, denser ink. But solid black tribal, heavy blackwork, dense black-and-grey, or thick lettering leave no room to go darker, so they usually need laser fading first before any cover-up with real imagery is possible."
      }
    },
    {
      "@type": "Question",
      "name": "Why does a cover-up tattoo have to be bigger than the original?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Because the artist needs room to land dense, dark areas directly over the old ink while placing lighter highlights and negative space on clean skin. Most cover-ups run around 30% larger than the original. Forcing coverage into the exact old outline reads heavy and muddy, and the old tattoo is more likely to ghost back through."
      }
    },
    {
      "@type": "Question",
      "name": "What's the difference between a cover-up and a blastover?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "A true cover-up hides the old tattoo completely so you can't find it in the new piece. A blastover deliberately layers bold new work over the old one and lets the original ghost through as an intentional layered effect. Cover-ups aim for concealment; blastovers lean into the contrast, usually with heavy black traditional or blackwork."
      }
    },
    {
      "@type": "Question",
      "name": "How many laser sessions do I need before a cover-up?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Fading for a cover-up usually takes fewer sessions than full removal — commonly four to eight rounds, spaced six to eight weeks apart. You only need to lighten the old ink enough for a new design to bury it, not erase it entirely. Black and dark blue fade fastest; lighter colours and dense professional work take longer."
      }
    },
    {
      "@type": "Question",
      "name": "What tattoo styles cover up old tattoos best?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Dark, dense, high-contrast styles work best — heavy black and grey realism, blackwork, bold neo-traditional, florals, and Japanese all carry the saturation and design density to bury old ink. Watercolour, fine line, and pastel work are nearly useless for coverage because they're too light to overpower what's already in the skin."
      }
    }
  ]
}
