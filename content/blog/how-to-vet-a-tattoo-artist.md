...
For the full breakdown on why fresh and healed look so different, [how tattoos age](/blog/how-tattoos-age) covers what actually happens to ink under the surface over time.
...
Scratcher signs are specific. Uneven, shaky lines that should be uniform. Solid color packed with visible trauma: blood, patchy light spots, beat-up skin. If the line weight varies dramatically across a piece that's supposed to be clean, [that's a technical tell, not a style choice](https://redemptioninksd.com/2024/12/04/how-to-spot-a-bad-tattoo-key-red-flags-to-look-out-for/).

The flash tell is real too. [If the portfolio is all small, common pieces you'd find on the shop wall](https://oracletattoogallery.com/what-is-the-sign-of-a-bad-tattoo-artist/), you're looking at a tracer, not an artist. Original work of real detail, across color, black and grey, different styles, is the signature of someone who does this as their medium, not a side hustle stencil-pusher.
...
The platform problem is bigger than any one artist. Feeds compress everything into the same square, strip the context, placement, scale, how long it's been healed, and reward color grading over craft. We dug into why [Instagram is quietly failing tattoo artists](/blog/instagram-failing-tattoo-artists) and the collectors trying to vet them.

This is half of why Tatulogue exists. Artists catalogue work with the context a feed throws away: style, placement, healed timeline. You're vetting on information, not a thumbnail. More on the why behind it in [what is Tatulogue](/blog/what-is-tatulogue).

If you're weighing where to actually find and book artists, [Tatulogue vs Booksy vs StyleSeat](/blog/tatulogue-vs-booksy-vs-styleseat) breaks down what each platform is built for.
...
If you're still narrowing what you actually want, the [2026 tattoo styles guide](/blog/tattoo-styles-guide-2026) maps the major styles, and the [complete fine line guide](/blog/fine-line-tattoos-complete-guide) covers the vetting that delicate work specifically demands. Style clarity makes artist matching ten times easier.
...
The infection risk here is not hypothetical. Tattooing breaks skin and generates blood, which is exactly why [OSHA's Bloodborne Pathogens standard applies to the tattoo industry](https://www.osha.gov/laws-regs/standardinterpretations/2002-07-29): every legitimate shop should operate under a written exposure-control plan. Most states also require artists to carry a [bloodborne pathogens certification before they can be licensed](https://www.osha.gov/bloodborne-pathogens), and many run a state or county health-department permit on top of it. Requirements vary by state, so check yours.
...
Run through the practical list. How do they translate a reference into a stencil, and when do you see the design? Hourly, flat, or day rate, and roughly how many sessions? [Walk in with these questions ready](https://hyperinkers.com/blog/questions-to-ask-your-tattoo-artist) so you're not improvising in the chair.

Watch how they handle pushback. An artist who tells you your fine-line idea is too small for your forearm, or that the placement will blow out, is protecting your tattoo, and protecting their portfolio. The [overworked-skin breakdown](/blog/overworked-skin-tattoo) shows what happens when nobody says no. Yes-to-everything is not a green flag.

On consult fees specifically: a respected artist's take is that [a consult shouldn't cost anything](https://www.huffpost.com/entry/tattoo-artist-red-flags-doing-wrong_l_6568b4c5e4b07b937ff3e81f), and a steep upfront charge can signal scammy pricing downstream.
...
Non-refundable is the norm, not a scam. [The deposit protects the artist's time](https://www.solanatattoo.com/post/everything-you-need-to-know-about-a-tattoo-deposit): the hours spent drawing your custom piece and the slot they're holding instead of booking someone else. Expecting a serious artist to draw custom work for free is the actual red flag.
...
We track this stuff in the open: real healed work, honest artist takes, no content-farm filler. The [Tatulogue newsletter at tatulogue.com](https://tatulogue.com) is where collectors stay sharp on who's worth booking and what to watch for.
...
```json
{
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "How do you read a tattoo portfolio the right way?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Separate fresh shots from healed work, then judge consistency across the whole body of pieces instead of the single best one. Fresh ink looks tighter and darker than it heals, so it's only useful for judging execution on the day. Healed work, ideally one to three years in skin, is the honest preview of what you're paying for. A confident artist will show both."
      }
    },
    {
      "@type": "Question",
      "name": "What are the biggest tattoo artist red flags?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Wobbly or inconsistent linework, a portfolio stuffed with traced wall flash, zero healed photos, sketchy hygiene, and copied designs lifted from other artists. Solid color packed with visible blood or patchy light spots is a scratcher tell. A dramatic price drop to get you booked is another. Any one of these is a reason to slow down; two or more and you walk."
      }
    },
    {
      "@type": "Question",
      "name": "How do you check a tattoo shop's hygiene and licensing?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Visit in person and confirm the shop runs like a medical space: single-use needles opened in front of you, a working autoclave for reusable tools, fresh gloves, barrier-wrapped surfaces, and sharps disposal. Confirm current local licensing: most states require artists to hold a bloodborne pathogens certification and a health-department permit. If anyone reuses needles or dodges sterilization questions, leave."
      }
    },
    {
      "@type": "Question",
      "name": "What should you ask at a tattoo consultation?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Ask how they turn a reference into a stencil and when you'll see the design, how pricing works (hourly, flat, or day rate), whether the deposit applies to the final cost, the revision process, and the touch-up policy. Watch how they handle pushback: an artist who says your idea is too small or will blow out is protecting your tattoo. Most reputable artists don't charge for a basic consultation."
      }
    },
    {
      "@type": "Question",
      "name": "Are tattoo deposits refundable?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Almost never. A deposit holds your slot and pays the artist for the time spent drawing your custom design, and it's standard practice for it to be non-refundable. It usually comes off the final price, so you're paying early rather than extra. Before handing it over, confirm the exact amount, that it applies to the total, and the reschedule and cancellation terms in writing."
      }
    }
  ]
}
